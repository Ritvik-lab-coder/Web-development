function clearAll() {
    const memeParent = document.querySelector('.Meme-content');
    const jokeParent = document.querySelector('.Joke-content');
    const quoteParent = document.querySelector('.Quote-content');
    const riddleParent = document.querySelector('.Riddle-content');
    memeParent.innerHTML = '';
    jokeParent.innerHTML = '';
    quoteParent.innerHTML = '';
    riddleParent.innerHTML = '';
}

function showMeme() {
    const randomMemeUrl = getRandomData("memes");
    const parent = document.querySelector('.Meme-content');
...
function showJoke() {
    ...
    const parent = document.querySelector('.Joke-content');
...
function showQuote() {
    ...
    const parent = document.querySelector('.Quote-content');
...
function showRiddle() {
    ...
    const parent = document.querySelector('.Riddle-content');
    const Question = document.createElement('p');
    Question.textContent = randomRiddle.question;
    Question.setAttribute('id', 'riddle-question');
...
function revealAnswers() {
    const parent = document.querySelector('.Riddle-content');
    const riddle = parent.querySelector('#riddle-question');
    const answer = parent.querySelector('#riddle-answer')
